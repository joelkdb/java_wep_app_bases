...
public class FichierUtils {
    ...
    /**
     * Cette methode nous permet de rechercher un fichier sur chaque disque local se trouvant sur la machine, dans un dossier et de
    ...
    public static boolean creationDossierCache(String lienDossier) throws IOException, InterruptedException {
        boolean exist = testExistenceDossier(lienDossier);
