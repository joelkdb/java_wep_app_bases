 ...
 */
package com.joel.webapp.journal.utils;
...
public class JournalUtils {
     ...
     */
    public void logJoelLog4j(String loggerName, Priority priority, String message) {
        try {
            Logger loggerJoel = Logger.getLogger(loggerName);
            URL u = getClass().getClassLoader().getResource("log4j.xml");            
            DOMConfigurator.configure(u);
            loggerJoel.log(priority, message);
        } catch (Exception e) {
            e.printStackTrace();
