...
public class MikiWsObjectTools<T extends Object> {
    ...
    /**
     * Cette methode permet de retourner une liste d'objet (type d'objet passé en parametre à la classe) resultants de l'url passé en parametre
    ...
    /**
     * Cette methode permet de retourner une liste d'objet (type d'objet passé en parametre à la classe) resultants du json passé en paramètre
     * @param json String contenant le json passé en paramètre(le json en question doit renfermé une liste de l'objet)
     * @return liste de l'objet passé en parametre au constructeur de la classe
     * MikiWsTools ou null s'il ya erreur
     */
    ...
    /**
     * Cette methode permet de retourner un objet (type d'objet passé en parametre à la classe) resultant de l'url passé en parametre
     * @param urlWebservice url du webservice (paramètre path obligatoire)
     * @return un objet (type d'objet passé en parametre à la classe) ou null s'il ya erreur
     */
    ...
    /**
     * Cette methode permet de retourner un objet (type d'objet passé en parametre à la classe) resultant du json passé en paramètre
     * @param json String contenant le json passé en paramètre(le json en question doit renfermé un seul objet)
     * @return un objet (type d'objet passé en parametre à la classe) ou null s'il ya erreur
     */
    ...
    /**
     *Cette methode permet d'ajouter un objet(type d'objet passé en parametre à la classe) à l'url passé en parametre
     * @param urlWebservice url du webservice (pas besoin de paramètre path)
    ...
    /**
     * Cette methode permet de modifier un objet(type d'objet passé en parametre à la classe) à l'url passé en parametre
     * @param urlWebservice url du webservice (paramètre path obligatoire)
    ...
    /**
     * Cette methode permet de supprimer un objet(type d'objet passé en parametre à la classe) à l'url passé en parametre
     * @param urlWebservice url du webservice (paramètre path obligatoire)
     * @return true si l'opération est un succès ou false sinon
     */
    ...
    /**
     * Cette methode permet de transformer en format Json l'objet passé en parametre
    ...
    /**
     * Cette methode permet de transformer en format Json une liste d'objet passé en paramètre
