 ...
 * @author Mikel
 */
public class MikiWsJsonTools {

    public MikiWsJsonTools() {
    }
    ...
    public List<Map<String, String>> lectureJson(List<String> listeAttribut, final JsonReader reader) throws IOException {
    ...
    /**
     * Cette methode permet de renvoyer une liste de map contenant pour chaque map, les attributs(passé en parametre) et leurs valeurs concernant un objet de la liste(liste d'objet resultant de l'url)
    ...
    /**
     * Cette methode permet de renvoyer une liste de map contenant pour chaque map, les attributs(passé en parametre) et leurs valeurs concernant un objet de la liste( liste d'objet dans le json passe en parametre)
    ...
    /**
     * Cette methode permet de renvoyer un map contenant les attributs(passé en parametre) et leurs valeurs
    ...
    /**
     *Cette methode permet de renvoyer sous format Json l'objet passé en paramètre
    ...
    /**
     *Cette methode permet de renvoyer sous format Json le contenu du map(attributs et leurs valeurs) passé en paramètre
    ...
    /**
     * Cette methode permet de renvoyer sous format d'un tableau Json le contenu de la liste passé en paramètre
    ...
    /**
     * Cette methode permet de renvoyer sous format Json une liste de map passé en paramètre, map contenant les attributs et leurs valeurs decrivant un objet
     * @param valueListeObjet une liste de Map d'objet, ce dernier contient les attributs à transformer et leurs valeurs
